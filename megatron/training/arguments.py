...
def _add_network_size_args(parser):
    ...
    group.add_argument('--old-num-layers', type=int, default=None,
                       help='Number of transformer layers.')
    group.add_argument('--old-encoder-num-layers', type=int, default=None,
                       help='Number of encoder transformer layers.')
    group.add_argument('--old-decoder-num-layers', type=int, default=None,
                       help='Number of decoder transformer layers.')
    group.add_argument('--old-pp-num', type=int, default=None,
                       help='Number of old pipeline parallel size.')
    group.add_argument('--old-ep-num', type=int, default=None,
                       help='Number of old experts parallel size.')
    group.add_argument('--old-decoder-first-pipeline-num-layers', type=int, default=None,
                       help='Number of old pipeline first stage layers num.')
    group.add_argument('--old-decoder-last-pipeline-num-layers', type=int, default=None,
                       help='Number of old pipeline last stage layers num.')
    return parser
...
def _add_validation_args(parser):
    ...
    group.add_argument('--do-chat', action='store_true',
                       default=False, help='If set, only chat.')
    group.add_argument('--do-chat-topk', type=int, default=1,
                       help='Top k while chat generation sampling.')
    group.add_argument('--do-chat-topp', type=float, default=0.,
                       help='Top p while chat generation sampling.')
    group.add_argument('--do-chat-temperature', type=float, default=0.95,
                       help='Temperature while chat generation sampling.')
