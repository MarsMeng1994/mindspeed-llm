...
@dataclass
class MLASelfAttentionSubmodulesV3:
...
class MultiLatentAttentionV3(Attention):
    ...
    def __init__(
        ...
        submodules: Union[MLASelfAttentionSubmodulesV3],
        layer_number: int,
...
class MLASelfAttentionV3(MultiLatentAttentionV3):
